...
import "../doctraketquaxetnghiem.scss";
                ...
                <Form>
                    <div>
                        <div className="row form-row">
                            <FormItem
                                label={
                                    <div className="form-input-label doctraketquaxetnghiem-form-input-label">
                                        BS chỉ định
                                    </div>
                                }
                                className="col-md-5"
...
export default Thongtinxetnghiem;
