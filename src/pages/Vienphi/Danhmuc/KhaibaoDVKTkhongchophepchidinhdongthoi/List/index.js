...
import "../../danhmuc.scss";
import "./khaibaoDVKTkhongchophepchidinhdongthoi.scss";
import Search from "antd/es/input/Search";
function KhaibaoDVKTkhongchophepchidinhdongthoi() {
                ...
                <div className="text-muted">
                    <div className="d-flex justify-content-between align-items-center mt-2 mx-2">
                        <div className="d-flex align-items-center w-100">
                            <div className="vienphi-danhmuc-title mx-2 w-30">
                    ...
                    <div className="m-1">
                        <div className="row m-0">
                            <div className="col-md-6 px-1">
                                <div className="form-input-label">Danh sách DVKT</div>
                                <Table
                                    columns={column0}
                                    dataSource={ds}
                                    // loading={loading}
                            ...
                            <div className="col-md-6 px-1">
                                <div className="form-input-label">
                                    Danh sách DVKT không được chỉ định cùng lúc
                                </div>
                                <Table
                                    columns={column1}
                                    dataSource={ds}
...
export default KhaibaoDVKTkhongchophepchidinhdongthoi;
